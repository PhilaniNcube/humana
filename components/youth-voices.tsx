...
const youthVoices = [
  {
    ...
    stories: [
      ...
      },
      {
        ...
        video:
          "https://www.youtube.com/watch?si=FcEIBLQp91-2TfHB&v=p_S4ltwYMeQ&feature=youtu.be",
      },
      {
        ...
        video:
          "https://www.youtube.com/watch?si=yTkZxtUelgJfaXWx&v=SukDvlF7HQs&feature=youtu.be",
      },
    ],
  },
  {
    ...
    icons: [
      "/images/stats/72_financial_barriers.png",
      "/images/stats/54_lack_of_information.png",
      "/images/stats/38_rural_accessibility.png",
    ],
    stats: [
    ...
    stories: [
      {
        ...
        video:
          "https://www.youtube.com/watch?si=HvG9Ezfc8zEZuPMt&v=wQiHYtc0DyM&feature=youtu.be",
      },
      {
        name: "Huda Arbab",
        ...
        video:
          "https://www.youtube.com/watch?si=ln3-5_tA34ZDHKMY&v=nMI2srP33fQ&feature=youtu.be",
      },
      {
  ...
  },
  {
    ...
    icons: ["/images/stats/demanded_skills.png"],
    stats: [
  ...
  return (
    <section id="youth" className="mb-16 relative isolate">
      <ChevronDown
        ...
        onClick={() => scrollToElement("policymakers")}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 container mx-auto">
            <div className="flex items-start space-x-10">
              ...
              <div className="text-white">
                <h3 className={cn(bebasNeue.className, "text-6xl")}>
                  A generation <br />
                  ready to lead
                </h3>
                <h4 className="text-brand-green text-2xl font-bold">
                  it&apos;s time to put their voices at the center.
                </h4>
                <p className="mt-8 text-lg">
                  <strong>
                    Meet the changemakers of the Africa Skills Revolution.
                  </strong>
                </p>
                <p className="mt-6 text-base">
                  Use the map to explore where our{" "}
                  <strong className="font-extrabold">
                    competition winners
                  </strong>{" "}
                  come from. From bustling cities to rural towns and refugee
                  communities, these young people embarked on TVET and used
                  their skills to tackle Africa’s most pressing challenges. Each
                  dot marks a story of vision, resilience, and impact.{" "}
                </p>
              </div>
            </div>
        ...
        <div className="lg:px-[40px] px-4">
          ...
          <div>
            {youthVoices.map((item) => {
              return (
                <div key={item.title}>
                  <div className="w-full bg-brand-orange p-4 rounded-lg mb-6">
                    <h3 className="text-center text-2xl lg:text-4xl  font-bold my-3">
                      {item.title}
                    </h3>
                    <p className="text-center text-xl lg:text-2xl text-white font-light mt-4">
                      {item.description}
                    </p>
                  </div>
