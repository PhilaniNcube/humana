    ...
    <div className="bg-brand-orange relative isolate">
      <div className="px-4 lg:px-[40px] pt-24 text-center flex flex-col items-center w-full h-full">
        <h1
          className={cn(
            bebasNeue.className,
            "text-6xl lg:text-[100px] text-center text-white"
          )}
        >
        ...
        <div className="relative isolate">
          ...
          >
            <path
              d="M152.5 253.499L0 310.999L183.5 366.499L152.5 253.499Z"
              fill="#D9D9D9"
            />
            <path
              d="M434.5 144.999L162.5 217.499L349 302.499L434.5 144.999Z"
              fill="#F38E22"
            />
            <path
              d="M364.715 140.308L450.172 0.683103L308.449 38.1447L364.715 140.308Z"
              fill="#00b8cc"
            />
            <path
              d="M231 399.499L221 315.499L278.5 363.499L231 399.499Z"
              fill="#00B6CC"
            />
          </svg>
          <Image
