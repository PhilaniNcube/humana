...
import { ChevronDown, ChevronUp, Lightbulb, Package, RotateCw } from 'lucide-react';
...
const StoryCard: React.FC<{ story: StoryProps }> = ({ story }) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`card-inner ${isMobile && showMobileHint ? 'mobile-card-hint-animation' : ''}`}
          style={{
        ...
        >
            ...
            <div className="mt-auto space-y-4">
              {isMobile && (
                <div className="space-y-2">
                  <div className="text-xs text-center text-gray-500 mb-1">Tap card to flip</div>
                  <Button
          ...
          >
            ...
            <div className="flex justify-between mt-auto">
              {isMobile && (
                <div className="space-y-2">
                  <div className="text-xs text-center text-gray-500 mb-1">Tap card to flip back</div>
                  <Button
