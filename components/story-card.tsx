...
const StoryCard: React.FC<{ story: StoryProps }> = ({ story }) => {
  ...
  return (
    <div className="story-card-container h-[500px] w-full perspective-1000">
      <div 
      ...
      >
        ...
        <Card 
          className="absolute w-full h-full flex flex-col justify-between p-6 shadow-lg rounded-lg" 
